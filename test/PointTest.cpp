...
TEST(pointTest, success_add_ed25519point_7) {
  mpz_class point1X = mpz_class("31621228259983782766387151846173419701451207683454700670358544852161525834558", BASE);
  mpz_class point1Y = mpz_class("1087550498622212171315934886475455672530696511327350732598338573849547859723", BASE);
  mpz_class point2X = mpz_class("53796438671359824102085853653404738634771041230653645888564199631429825277660", BASE);
  mpz_class point2Y = mpz_class("52873790972168047993308827189322012202737756658766965387349495052412272053380", BASE);
  ...
  mpz_class expectX = mpz_class("10231238983259957665520424972260773583563625054906107477931951171166394182461", BASE);
  mpz_class expectY = mpz_class("16175802527788616834701228315101703266962390276165245252584971134833495651114", BASE);
...
TEST(pointTest, success_add_ed25519point_8) {
  mpz_class point1X = mpz_class("24714885350915573524959492804958774885039633758708007137167239543662320763472", BASE);
  mpz_class point1Y = mpz_class("32610704945606948033834599741453719010166132071117736619400925734673110257760", BASE);
  mpz_class point2X = mpz_class("31621228259983782766387151846173419701451207683454700670358544852161525834558", BASE);
  mpz_class point2Y = mpz_class("1087550498622212171315934886475455672530696511327350732598338573849547859723", BASE);
  ...
  mpz_class expectX = mpz_class("35609955356486491496360028406142810435910830517694536589708456029301666527874", BASE);
  mpz_class expectY = mpz_class("33972043234789475673904984064588138758737764726163691391551272801822821209432", BASE);
